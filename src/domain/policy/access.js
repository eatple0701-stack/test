...
export const GATE_TEXT = {
  'join-table': {
    ...
    titleAr: "طلب مقعد يحتاج حسابًا",
    titleZh: "申请位子需要一个账号",
    titleJa: "席をリクエストするにはアカウントが必要です",
    ...
    bodyAr: "المقعد على مائدة وعد لأشخاص حقيقيين، ولذلك يحتاج الفريق إلى وسيلة للوصول إليك إن تغيّرت الخطط. أمّا تصفّح الموائد والأطباق والنصائح فيبقى مفتوحًا بلا حساب.",
    bodyZh: "饭桌上的一个位子是对真实的人许下的承诺，所以团队需要一个在计划有变时能联系上你的办法。至于看饭桌、看菜、看攻略，没有账号也一直开着。",
    bodyJa: "食卓の席は実在の人への約束なので、予定が変わったときに連絡できる手段がチームには要ります。食卓も料理も案内も、見るだけならアカウントなしで開いたままです。",
  ...
  'open-table': {
    ...
    titleAr: "فتح مائدة يحتاج حسابًا",
    titleZh: "开一张饭桌需要一个账号",
    titleJa: "食卓を開くにはアカウントが必要です",
    ...
    bodyAr: "أن تكون مضيفًا يعني أن يرتّب غرباء أمسيتهم حولك، ولذلك يسجّل المضيفون أولًا. أمّا النظر فلا يحتاج حسابًا.",
    bodyZh: "当主人意味着陌生人会围着你安排他们的晚上，所以主人先注册。只是看看，不需要账号。",
    bodyJa: "ホストになるとは、知らない人があなたを軸に夜の予定を組むということなので、ホストは先に登録します。見て回るだけならアカウントは要りません。",
    cta: '가입하고 계속 · Join and continue',
    ctaEs: 'Únete y continúa',
    ctaFr: "Rejoignez et continuez",
    ctaAr: "انضمّ وتابع",
  ...
  'request-table': {
    ...
    titleAr: "أن تخبرنا بما تبحث عنه يحتاج حسابًا",
    titleZh: "告诉我们你想找什么，需要一个账号",
    titleJa: "探しているものを伝えるにはアカウントが必要です",
    ...
    bodyAr: "حين يفتح التطبيق مائدة نيابةً عنك، لا بد أن يكون أحدهم قابلًا للوصول حين يحين اللقاء. والتصفّح يبقى مفتوحًا بلا حساب.",
    bodyZh: "当应用替你开一张饭桌时，得有人在配上的时候联系得上。浏览仍然不需要账号。",
    bodyJa: "アプリが代わりに食卓を開くとき、話がまとまった時点で連絡のつく人がいる必要があります。見て回るのはアカウントなしで開いたままです。",
    cta: '가입하고 계속 · Join and continue',
    ctaEs: 'Únete y continúa',
    ctaFr: "Rejoignez et continuez",
    ctaAr: "انضمّ وتابع",
  ...
  passport: {
    ...
    titleAr: "أنشئ ملفك وجواز سفرك",
    titleZh: "建立你的资料和护照",
    titleJa: "プロフィールとパスポートをつくる",
    ...
    bodyAr: "ملفك — الاسم واللغات وما تأكله — يُكتب مرة واحدة عند التسجيل، وتقرأه بعد ذلك كل مائدة. وجواز السفر أدناه يمتلئ بأمسياتك كلّما حدثت. النظر يبقى مفتوحًا بلا حساب؛ أمّا أن يكون لك واحد فتسجيل واحد.",
    bodyZh: "你的资料——名字、语言、你吃什么——在注册时写一次，之后每一张饭桌都会读它。下面的护照会随着你的每一个夜晚慢慢填满。只是看看不需要账号；要有自己的一份，是一次注册。",
    bodyJa: "プロフィール——名前、話す言語、食べるもの——は登録のときに一度書けば、以後どの食卓もそれを読みます。下のパスポートは、あなたの夜が起きるたびに埋まっていきます。見て回るのはアカウントなしで、自分のものを持つのは一度の登録です。",
    cta: '만들기 · Create mine',
    ctaEs: 'Crear el mío',
    ctaFr: "Créer le mien",
    ctaAr: "أنشئ ملفي",
