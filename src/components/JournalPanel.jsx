...
export default function JournalPanel({
  ...
  const goals = useMemo(() => [
    ...
    {
      id: 'three-dishes',
      name: "Three dishes you'd rather not eat alone",
      nameKo: '혼자보다 같이 먹고 싶은 요리 세 가지',
      nameEs: 'Tres platos que prefieres no comer solo',
      nameFr: 'Trois plats que vous préféreriez ne pas manger seul',
      nameAr: 'ثلاثة أطباق تفضّل ألّا تأكلها وحدك',
      nameZh: '三道你不想一个人吃的菜',
      nameJa: 'ひとりでは食べたくない料理を三つ',
