...
const tabs = [
  ...
  { id: 'main', label: 'Main', kr: '메인', es: 'Inicio', fr: 'Accueil', ar: 'الرئيسية', zh: '首页' },
  { id: 'home', label: 'Explore', kr: '문화', es: 'Cultura', fr: 'Culture', ar: 'ثقافة', zh: '文化' },
  { id: 'match', label: 'Tables', kr: '밥상', es: 'Mesas', fr: 'Tables', ar: 'موائد', zh: '饭桌' },
  { id: 'places', label: 'Places', kr: '장소', es: 'Sitios', fr: 'Lieux', ar: 'أماكن', zh: '地点' },
  ...
  { id: 'journal', label: 'Passport', kr: '여권', es: 'Pasaporte', fr: 'Passeport', ar: 'الجواز', zh: '护照' },
    ...
    <nav className="tab-bar" aria-label="Primary">
      {tabs.map(t => (
        <button
          ...
          title={isCollapsed ? say(t.label, t.kr, t.es, t.fr, t.ar, t.zh) : undefined}
        >
          {icons[t.id]}
          ...
          <span className="tab-label">{say(t.label, t.kr, t.es, t.fr, t.ar, t.zh)}</span>
        </button>
      ))}
    </nav>
  );
