...
export const featuredZones = [
  { name: 'Insadong', nameKo: '인사동', nameEs: 'Insadong', nameFr: "Insadong", zone: 'Insadong, Seoul', blurb: 'Tea houses, hanbok, temple food', blurbKo: '찻집과 한복, 사찰음식', blurbEs: 'Casas de té, hanbok, cocina de templo', blurbFr: "Maisons de thé, hanbok, cuisine de temple", },
  { name: 'Itaewon', nameKo: '이태원', nameEs: 'Itaewon', nameFr: "Itaewon", zone: 'Itaewon, Seoul', blurb: 'The most international night in Seoul', blurbKo: '서울에서 가장 국제적인 밤', blurbEs: 'La noche más internacional de Seúl', blurbFr: "La nuit la plus internationale de Séoul", },
  { name: 'Bukchon', nameKo: '북촌', nameEs: 'Bukchon', nameFr: "Bukchon", zone: 'Bukchon, Seoul', blurb: 'Hanok alleys and quiet zero-waste kitchens', blurbKo: '한옥 골목과 조용한 제로웨이스트 주방들', blurbEs: 'Callejones de hanok y cocinas discretas sin residuos', blurbFr: "Ruelles de hanok et cuisines zéro déchet", },
  { name: 'Myeongdong', nameKo: '명동', nameEs: 'Myeongdong', nameFr: "Myeongdong", zone: 'Myeongdong, Seoul', blurb: 'Street snacks, shopping, halal Korean', blurbKo: '길거리 간식과 쇼핑, 할랄 한식', blurbEs: 'Puestos callejeros, compras y cocina coreana halal', blurbFr: "Snacks de rue, shopping, coréen halal", },
];
...
export const seasonalFoods = [
  {
    id: 'ssukguk', name: 'Ssukguk', nameKo: '쑥국', season: 'Spring', seasonKo: '봄', seasonEs: 'Primavera', seasonFr: 'Printemps', months: [3, 4, 5],
  ...
  {
    id: 'samgyetang', name: 'Samgyetang', nameKo: '삼계탕', season: 'Summer', seasonKo: '여름', seasonEs: 'Verano', seasonFr: 'Été', months: [6, 7, 8],
  ...
  {
    id: 'jeon', name: 'Autumn Jeon', nameKo: '전', season: 'Fall', seasonKo: '가을', seasonEs: 'Otoño', seasonFr: 'Automne', months: [9, 10, 11],
  ...
  {
    id: 'kimjang', name: 'Kimjang Kimchi', nameKo: '김장', season: 'Winter', seasonKo: '겨울', seasonEs: 'Invierno', seasonFr: 'Hiver', months: [12, 1, 2],
