...
export const featuredZones = [
  { name: 'Insadong', nameKo: '인사동', zone: 'Insadong, Seoul', blurb: 'Tea houses, hanbok, temple food', blurbKo: '찻집과 한복, 사찰음식' },
  { name: 'Itaewon', nameKo: '이태원', zone: 'Itaewon, Seoul', blurb: 'The most international night in Seoul', blurbKo: '서울에서 가장 국제적인 밤' },
  { name: 'Bukchon', nameKo: '북촌', zone: 'Bukchon, Seoul', blurb: 'Hanok alleys and quiet zero-waste kitchens', blurbKo: '한옥 골목과 조용한 제로웨이스트 주방들' },
  { name: 'Myeongdong', nameKo: '명동', zone: 'Myeongdong, Seoul', blurb: 'Street snacks, shopping, halal Korean', blurbKo: '길거리 간식과 쇼핑, 할랄 한식' },
];
